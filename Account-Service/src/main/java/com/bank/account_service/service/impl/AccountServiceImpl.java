...
public class AccountServiceImpl implements AccountService {
    ...
    public AccountResponse createAccount(AccountRequest request) {
        ...
        List<Account> customerAccounts = accountRepository.findAllByClientId(request.getClientId());
     ...
     */
    @Override
    public Page<AccountResponse> getAccountsByClientId(Long clientId, int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<Account> accountsPage = accountRepository.findByClientId(clientId, pageable);
